"""Instrument manager for ATM strike determination and subscription management."""
...
class InstrumentManager:
    """Manage instrument master and ATM strike determination."""
    ...
    async def load_instrument_master(
        ...
        await self.session.execute(
            "DELETE FROM instrument_master WHERE symbol = 'NIFTY';"
        )
